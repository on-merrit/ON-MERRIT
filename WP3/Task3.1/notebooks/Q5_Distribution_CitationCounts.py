...
# ## Question : What is the ditibution of incoming citation counts for OA and non-OA papers published by THE WUR univ within each country?
...
#             Get the total count of citations for OA and unknown papers
...
create_citation_count_distribution_bar_chart(univs_details, save_fname = join(output_dir,country_name+"_"+'citationcount_distribution'), x_label = ("Universities in "+country_name), save_file=False)'''
...
for country_name, univs_details in all_countries_all_univs_OA_info.items():
    create_citation_count_distribution_bar_chart(univs_details, save_fname = join(output_dir,country_name+"_"+'citationcount_distribution'), x_label = ("Universities in "+cnames_for_plot[country_name]), save_file=True)
