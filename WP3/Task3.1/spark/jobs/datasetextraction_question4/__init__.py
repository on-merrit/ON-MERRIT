'''
Extracts data from MAG to support answer to dataset selection question 4:

"Distribution of seniority (number of years since first publication until last publication) of
 staff at a particular university."

This program just extracts relevant data from MAG and stores that as a csv. Another program has to be called on top of
the dataset to analyze the data.
